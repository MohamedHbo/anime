            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="./index.html">
                            <h5 class="text-white">Game <span class="text-danger">Store</span></h5>
                        </a>
                    </div>
                </div>
                <div class="col-lg-8">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <a href="#" class="btn btn-danger mt-2"><span>Play Now</span> <i class="fa fa-angle-right"></i></a>
    ...
    <div class="product__sidebar__comment">
        ...
        <div class="product__sidebar__comment__item">
            ...
            <div class="product__sidebar__comment__item__text">
                ...
                <a href="#" class="btn btn-danger mt-2"><span>Play Now</span></a>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer__logo">
                    <h3 class="text-white">Game <span class="text-danger">Store</span></h3>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-3">
                <p>
                  All rights reserved |this website Made with <i class="fa fa-heart" aria-hidden="true"></i> by Nibras Daboul</a>
                 </p>
              </div>
          </div>
      </div>
